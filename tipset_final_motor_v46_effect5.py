...
if __name__ == '__main__':
    # Säkerhetsguard för Streamlit Cloud: motorfilen ska normalt importeras av app.py.
    # Kör bara Colab/CLI-main om filen uttryckligen startas med argument.
    import sys as _sys
    if any(str(a).startswith('--') for a in _sys.argv[1:]):
        main_v46()
    else:
        print('Detta är motorfilen för Tipset AI. Kör app.py i Streamlit och låt appen importera denna fil.')
